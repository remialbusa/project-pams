            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item text-center active">
                        <img src="./images/handshake-colour-thumbnail.png" class="rounded mx-auto d-block img-fit"
                            alt="...">
    ...
    <section class="container feature pt-5 mt-5">
        ...
        <div class="row mt-5 d-flex justify-content-end" data-aos="fade-right" data-aos-delay="100">
            <div class="col card-wrap mb-1 mt-4">
                <img src="./images/Technical_Support.jpg" class="rounded mx-auto d-block technical-img"
                    alt="...">
            </div>
                    ...
                    <form action="{{ route('submit-form') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <div>
                                ...
                                <input type="text" class="technical-form mt-2 mt-1 border-strong" name="program"
                                    placeholder="Program">
                            ...
                            <div>
                                ...
                                <input type="text" class="technical-form mt-1 border-strong" name="id_no"
                            ...
                            <div>
                                ...
                                <input type="text" class="technical-form mt-1 border-strong" name="name"
                                    placeholder="Name">
                                <span class="text-danger">
                                    @error('name')
                                        {{ $message }}
                            ...
                            <div>
                                ...
                                <input type="text" class="technical-form mt-1 mt-1 border-strong" name="email"
                                    placeholder="Email">
                                <span class="text-danger">
                                    @error('email')
                                        {{ $message }}
                            ...
                            <div>
                                ...
                                <input style="height: 100px;" class="technical-form mt-1 mt-1 border-strong"
                                    name="concern" placeholder="Concern">
                                <span class="text-danger">
                                    @error('concern')
                                        {{ $message }}
                                    @enderror
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-4 my-auto">
                    <img class="footer-logo" src="https://www.enrollment.lnu.edu.ph/assets/images/lnu_logo.png"
                        alt="logo" />
                ...
                <hr>
                <p class="text-light text-center">© Copyright <b>Leyte Normal university</b> . All Rights Reserved 2022
                </p>
            </div>
    </footer>
