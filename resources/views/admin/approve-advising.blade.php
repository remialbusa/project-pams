        ...
        <div class="manage-users-body container mt-5">
            <div class="container h-100">
                <div class=" px-4 mt-5 mb-5">
                    ...
                    <hr />
                    <form action="{{ route('approve-advising') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="profile mt-5">
                            ...
                            <div class="row mt-2 mb-3">
                                ...
                                <div class="col-sm-6 mt-2">
                                    <div class="form-outline">
                                        ...
                                        <input type="text" id="form6Example2" class="form-control" name="first_period_schedule" value="{{$student['time_first_period_sub']}}" readonly/>
                                    </div>
                                </div>
                                <div class="col mt-3 mt-2">
                                    <div class="form-outline">
                                        <label class="form-label" for="form6Example1">Instructor</label>
                                        <input type="text" id="form6Example2" class="form-control" name="first_instructor" value="{{$student['first_period_instructor']}}"  />
                                        <span class="text-danger">@error('first_instructor'){{$message}} @enderror</span>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3"></div>
                            <div class="row mt-2 mb-3">
                                ...
                                <div class="col-sm-6 mt-2">
                                    <div class="form-outline">
                                        <label class="form-label" for="form6Example2">Schedule<label class="text-danger">*</label></label>
                                        <input type="text" id="form6Example2" class="form-control" name="second_period_schedule" value="{{$student['time_second_period_sub']}}" readonly/>
                                    </div>
                                </div>
                                <div class="col mt-3 mt-2">
                                    <div class="form-outline">
                                        <label class="form-label" for="form6Example1">Instructor</label>
                                        <input type="text" id="form6Example2" class="form-control" name="second_instructor" value="{{$student['second_period_instructor']}}" />
                                        <span class="text-danger">@error('second_instructor'){{$message}} @enderror</span>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3"></div>
                            <div class="row mt-2 mb-3">
                                ...
                                <div class="col-sm-6 mt-2">
                                    <div class="form-outline">
                                        <label class="form-label" for="form6Example2">Schedule<label class="text-danger">*</label></label>
                                        <input type="text" id="form6Example2" class="form-control" name="third_period_schedule" value="{{$student['time_third_period_sub']}}" readonly/>
                                    </div>
                                </div>
                                <div class="col mt-3 mt-2">
                                    <div class="form-outline">
                                        <label class="form-label" for="form6Example1">Instructor</label>
                                        <input type="text" id="form6Example2" class="form-control" name="third_instructor" value="{{$student['third_period_instructor']}}" />
                                        <span class="text-danger">@error('third_instructor'){{$message}} @enderror</span>
                                    </div>
                                </div>
                            </div>
