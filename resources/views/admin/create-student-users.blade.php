        ...
        <div class="manage-users-body container mt-5">
            <div class="container h-100">
                <div class="px-4 mt-5 mb-5">
                    <h4>Creating Student User Data</h4>
                    <hr />
                    <form action="{{route('create-student-users')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col mt-4">
                                    <div class="form-outline ">
                                        ...
                                        <select class="form-select form-line" aria-label="Default select example" name="first_procedure">
                                            @if($student['first_procedure'] == 'Pending')
                                ...
                                <div class="col mt-4">
                                    <div class="form-outline ">
                                        ...
                                        <select class="form-select form-line" aria-label="Default select example" name="second_procedure">
                                            @if($student['second_procedure'] == 'Pending')
                                            <option value="Pending">Pending</option>
                                            <option value="Done">Done</option>
                                            @else
                                            <option value="Done">Done</option>
                                ...
                                <div class="col mt-4">
                                    <div class="form-outline ">
                                        ...
                                        <select class="form-select form-line" aria-label="Default select example" name="third_procedure">
                                            @if($student['third_procedure'] == 'Pending')
                                            <option value="Pending">Pending</option>
                                            <option value="Done">Done</option>
                                            @else
                                            <option value="Done">Done</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-outline form-line">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="vaccination_status">
                                                @if($student->vaccination_status == 'Fully Vaccinated')
                                    ...
                                    <div class="col">
                                        <div class="form-outline form-line">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="program">
                                                <option value="{{$student->program}}">{{$student->getProgramID->program}} - {{$student->getProgramID->description}}</option>
                                            </select>
